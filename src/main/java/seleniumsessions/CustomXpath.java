...
//				}
		...
		String text = driver.findElement(By.xpath("((//div[@class='col-sm-3'])[last()]//a)[last()]")).getText();
		System.out.println(text);
		if(text.equals("Newsletter")) {
			System.out.println("PASS");
		}
		else {
			System.out.println("FAIL");
		...
		//  ((//div[@class='col-sm-3'])[last()]//a)[last()]
		...
		// input[@name='firstname']/ancestor::div[@class='form-group]
		// required']/label[@for='input-firstname']

		// child-->parent --> child

		// child-parent-preceding-sibling-child
