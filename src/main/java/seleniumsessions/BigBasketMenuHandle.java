...
public class BigBasketMenuHandle {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		multliMenuHandle(parentShopByMenu, beveragesSecondMenu, teaThirdMenu, greenTeafourthMenu);
	...
	public static void multliMenuHandle1(By parentMenuLocator, By firstChildMenuLocaor, By secondChildMenuLocaor,
		...
		act.pause(500).moveToElement(getElement(firstChildMenuLocaor)).pause(500)
				.moveToElement(getElement(secondChildMenuLocaor)).pause(500).click(getElement(thirdChildMenuLocaor))
				.build().perform();
